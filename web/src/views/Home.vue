...
const coreModules = [
  ...
  { id: 'model3d', title: '3D 模型', subtitle: '3D Assets', description: '保留腾讯 3D 与 Tripo 3D 双路线，可根据场景选择不同模型完成三维资产生成。', icon: IconApps, path: '/model3d', color: 'linear-gradient(135deg, #84FAB0 0%, #8FD3F4 100%)', bgLight: 'rgba(143, 211, 244, 0.08)' },
]

const upcomingModules = [
  { id: 'music', title: '音乐创作', subtitle: 'Audio Studio', description: '智能生成背景音乐与音效，满足多元化的数字媒体内容创作需求。', icon: IconMusic, color: 'linear-gradient(135deg, #667EEA 0%, #764BA2 100%)', bgLight: 'rgba(118, 75, 162, 0.08)', actionText: '内容筹备中' },
...
// Dashboard 顺序: [Chat, Draw, Canvas, Video] + 5 个筹备中
