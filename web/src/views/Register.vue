...
const validateConfirm = (_value: string, cb: (err?: string) => void) => {
...
.register-input :deep(.arco-input-wrapper),
.register-input :deep(.arco-input-password) {
...
.register-input :deep(.arco-input-wrapper:focus-within),
.register-input :deep(.arco-input-password:focus-within) {
