...
export class AuthService {
  ...
  private async resolveRegisterBalance(): Promise<number> {
    const configured = await this.globalConfigService.getConfig('defaultPoints');
  ...
  async register(
    ...
    const initialBalance = await this.resolveRegisterBalance();
