...
export class GlobalConfigService implements OnModuleInit {
  ...
  private readonly presets: PresetConfig[] = [
    ...
    {
      key: 'GRS_API_URL',
      val: 'https://grsai.dakka.com.cn',
      description: 'GrsAI 接口地址',
    },
    ...
    { key: 'KIE_API_KEY', val: '', description: 'Kie AI 音乐服务 API Key' },
    {
      key: 'HTTP_PROXY',
      val: '',
      description: 'HTTP 代理（可选，如 http://127.0.0.1:7890）',
    },
    {
      key: 'HTTPS_PROXY',
      val: '',
      description: 'HTTPS 代理（可选，如 http://127.0.0.1:7890）',
    },
    {
      key: 'NO_PROXY',
      val: '',
      description: '不走代理的域名列表（逗号分隔，可选）',
    },
