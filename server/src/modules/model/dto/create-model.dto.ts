...
export class CreateModelDto {
  ...
  @ApiPropertyOptional({ description: '模型来源，如 local / preset / mapi' })
  @IsOptional()
  @IsString()
  @MaxLength(32)
  source?: string;

  @ApiPropertyOptional({ description: '上游平台模型 ID' })
  @IsOptional()
  @IsString()
  @MaxLength(160)
  upstreamModelId?: string;

  @ApiPropertyOptional({ description: '能力标签 JSON 字符串' })
  @IsOptional()
  @IsString()
  capabilityTags?: string;

  @ApiPropertyOptional({ description: '原始元数据 JSON 字符串' })
  @IsOptional()
  @IsString()
  rawMetadata?: string;
