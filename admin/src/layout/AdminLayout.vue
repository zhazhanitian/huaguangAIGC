      ...
      <div class="sb-logo" @click="navigate('/dashboard')">
        ...
        <transition name="fade-text">
          <div v-if="!collapsed" class="sb-logo-text">
            <span class="sb-logo-title">华光 AIGC</span>
...
.mesh-bg .blob { position: absolute; border-radius: 50%; filter: blur(90px); opacity: 0.15; animation: meshMove 20s ease-in-out infinite; }
.mesh-bg .blob-1 { width: 520px; height: 520px; background: #165DFF; top: -12%; left: -8%; }
.mesh-bg .blob-2 { width: 420px; height: 420px; background: #4080FF; bottom: -14%; right: -8%; animation-delay: -7s; }
.mesh-bg .blob-3 { width: 360px; height: 360px; background: #14C9C9; top: 45%; left: 52%; animation-delay: -14s; }
...
.sb-logo-text { display: flex; flex-direction: column; min-width: 0; }
.sb-logo-title {
  font-size: 15px; font-weight: 800; letter-spacing: 0.02em;
  background: linear-gradient(135deg, #4080FF, #14C9C9);
  -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
}
.sb-logo-sub { font-size: 10px; color: var(--text-4); letter-spacing: 0.1em; text-transform: uppercase; }
...
.sb-group + .sb-group { margin-top: 8px; }
...
.sidebar.collapsed .sb-item { justify-content: center; padding: 0; }
...
.sb-item-label { font-size: 14px; font-weight: 600; white-space: nowrap; }
...
.sb-user-avatar { background: var(--gradient-primary) !important; color: #fff; flex-shrink: 0; font-weight: 700; }
...
.sb-toggle:hover { background: rgba(255,255,255,0.06); color: var(--text-1); }

/* ===== Transition ===== */
.fade-text-enter-active { transition: opacity 0.2s ease 0.08s; }
...
.breadcrumb :deep(.arco-breadcrumb-item) { color: var(--text-3); font-size: 14px; }
.breadcrumb :deep(.arco-breadcrumb-item:last-child) { color: var(--text-1); }
.breadcrumb :deep(a) { color: var(--text-2); }
.breadcrumb :deep(a:hover) { color: var(--primary-light); }

.header-right { display: flex; align-items: center; gap: var(--sp-4); }

.avatar-trigger { display: flex; align-items: center; gap: var(--sp-3); color: var(--text-2); }
.avatar { background: var(--gradient-primary) !important; color: #fff; font-weight: 700; }
.admin-name { font-size: 14px; color: var(--text-2); }

.content { flex: 1; padding: var(--sp-6); overflow: auto; }
.content-shell { max-width: 1240px; margin: 0 auto; width: 100%; }
</style>
